...
public record OpenQuestDisplayMessage(QuestDisplay display, boolean confirmationButtons, int entityId) {
    ...
    public void handle(Supplier<NetworkEvent.Context> supplier) {
        ...
        Minecraft.getInstance().setScreen(new DisplayQuestScreen(this.display(), this.confirmationButtons(), ClientQuests.lastTalkedEntityId));
    }
}
