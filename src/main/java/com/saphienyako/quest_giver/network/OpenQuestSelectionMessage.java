...
public record OpenQuestSelectionMessage(Component title, List<SelectableQuest> quests, int entityId) {
    ...
    public void handle(Supplier<NetworkEvent.Context> supplier) {
        ...
        Minecraft.getInstance().setScreen(new SelectQuestScreen(this.title(), this.quests(), ClientQuests.lastTalkedEntityId));
    }
}
